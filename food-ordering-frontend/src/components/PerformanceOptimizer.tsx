      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Settings className="h-5 w-5 text-crepe-purple" />
                Caching
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        {metrics.recommendations.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <AlertTriangle className="h-5 w-5 text-crepe-purple" />
            ...
            <CardContent>
              <div className="space-y-3">
                {metrics.recommendations.map((recommendation, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-3 p-3 bg-crepe-purple/5 rounded-lg"
                  >
                    <CheckCircle className="h-5 w-5 text-crepe-purple mt-0.5" />
