...
const KEYFRAMES = `
  ...
  @keyframes mn-glow-breathe {
    0%, 100% { box-shadow: 0 0 10px 2px rgba(212,175,55,0.12), 0 0 24px 6px rgba(212,175,55,0.06); }
    50%      { box-shadow: 0 0 16px 4px rgba(212,175,55,0.22), 0 0 36px 8px rgba(212,175,55,0.1); }
  }
  .mn-link {
    position: relative;
    font-weight: 600;
