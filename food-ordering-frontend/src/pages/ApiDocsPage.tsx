...
const ApiDocsPage = () => {
  ...
  const endpoints = [
    ...
    },
    {
      ...
      description: "Create a new order (Cash on Delivery)",
      auth: true,
      params: [],
      requestBody: {
        restaurantId: "string",
      ...
      example: `${baseUrl}/api/order/create`,
    },
    {
      method: "GET",
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 mb-6">
          Complete API reference for Crêpe Time Tunisia API
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">Paiement à la livraison (Cash)</p>
            </CardContent>
          </Card>
        </div>
      </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    {endpoint.auth && (
                      <Badge
                        variant="secondary"
                        className="bg-crepe-purple/10 text-crepe-purple"
                      >
                        Auth Required
                      </Badge>
                    )}
